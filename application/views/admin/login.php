...
<head>
  ...
  <title>MyPropertyBotique | Log in</title>
  ...
  <div class="login-box-body">
    ...
    <form id="admin_login_form" name="admin_login_form">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="button" id="adminLoginSubmitBtn" class="btn btn-primary btn-block btn-flat">Sign In</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
...
<script>
  ...
  $(document).ready(function(){
    ...
    $('#adminLoginSubmitBtn').click(function(e){
