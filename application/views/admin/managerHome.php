          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="pull-right">
                <button type="button" id="addProjModalBtn" class="btn btn-block btn-success" data-toggle="modal" data-target="#modal-default">
                Add Project
                </button>              
              </div>
            </div>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td><?=$r['status']?></td>
                  <td><a href="<?php echo base_url() ?>index.php/adminDashboard/mgrProjectDetail?id=<?php echo $r['project_id']; ?>" class="btn btn-info btn-sm">View</a></td>
                </tr>
                <?php } ?>
              </table>
            </div>
