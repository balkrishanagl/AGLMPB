         ...
         <div class="col-md-12 project-body">
             <div class="col-md-4">
                 ...
                 <div class="col-md-4 project-body">
                     <h4>2663 Sqft - 3263 Sqft</h4><p>Super Built Up Area</p></div>
                     <div class="col-md-4">
             ...
             <div class="project-detail-section-part">
              ...
              <div class="container">
                 <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 project-showcase">
                    <h3>Project Details</h3></div>   
                    <div class="table-project">
                        <table class="table table-bordered table-hover brochure">
                            <thead>
                                <tr>
                                    <th>FLOOR PLAN</th>
                                    <th>INCLUSIONS</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td> 
                                        <a class="open_fancybox" href="http://fancyapps.com/fancybox/demo/1_b.jpg"><img src="<?= base_url() ?>assets/home/assets/images/home-1.gif" alt=""/></a>
                                        <div class="Img" data-type="<?= base_url() ?>assets/home/assets/images/home-big.png" >
                                        </td>
                                        <td>
                                            <ul class="rooms">
                    ...
                    <div class="container">
                        <div class="quick-search">
                            ...
                            <ul>
                                ...
                                <li class="quickLink">
                                    <a href="">
                                        <img src="<?= base_url() ?>assets/home/assets/images/lift.png" />
                    ...
                    <div class="container">
                        <div class="project-search">
                            ...
                            <ul class="scroller">
                                <li class="quickLink">
                                    <a href="<?= base_url() ?>assets/home/assets/images/home-1.gif">
                                        <img src="<?= base_url() ?>assets/home/assets/images/home-1.gif" />
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="container">
                        <div class="project-search">
                            ...
                            <div class="col-md-12 brochure">
                                <div class="col-md-4">
                                    <a href="#"><img src="<?= base_url() ?>assets/home/assets/images/brochure.png"/>
                                    </a>
                                    <button class="btn btn-info center-block brochure-btn" style="border-radius: 0px !important;">Download Brochure</button>
                                </div>
                                <div class="col-md-4">
                                    <a href="#"><img src="<?= base_url() ?>assets/home/assets/images/brochure.png"/>
                                    </a>
