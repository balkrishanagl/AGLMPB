          ...
          <div class="container">
            <div class="row">   
                ...
                <div class="col-lg-12 col-det-banner-cont">
                    ...
                    <p>A hand-picked curated List of Featured Collections.</p>
                </div>
            </div>
        </div>
    </section>
      ...
      <div class="container nopadding">
        <div class="row">   
            <div class="col-lg-12 col-grp-cont nopadding">
                ...
                <div class="col-lg-4">
                <a href="<?=base_url()?>index.php/Home/featuredCollection?id=<?=$r['id']?>">
                    <div class="row">   
                        <div class="col-lg-12 grp-col-container">
                            <div class="col-lg-12 grp-col-new" style="padding:0px;">
                                <img src="<?= base_url() ?>assets/uploads/images/<?=$r['img_url']?>" alt="image" class="img-responsive img_card" >
                            </div>
