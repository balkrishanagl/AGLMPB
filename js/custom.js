$(document).ready(function() {
	...
	$(".btn-bdr").click(function(){
		...
		if($(this).parent().parent().parent().next("div").hasClass( "divshow" )){
			$('.job_profile_section').removeClass("divshow");
			$('ul').removeClass("active");
		}else{
			$('.job_profile_section').removeClass("divshow");
			$(this).parent().parent().parent().next("div").addClass("divshow");
			$(this).parent().parent().parent().addClass("active");
			
		}
		
	});	
	//End Career Collapse panel
	...
	$(".profile_row ul li a").click(function() {
		$(".profile_row ul li").removeClass("active");
	...
	$('.search_filter_btn').click( function() {
    	$(".search_left").toggleClass("show");
	});
	
	//Project call back Slide function
	$('.project_filter_btn').click( function() {
    	$(".right_panel").toggleClass("show");
	});
	...
	//Recognition SLider
	$('.recognition_slider').owlCarousel({
    	margin:0,
    	responsiveClass:true,
		autoplay:false,
    	autoplayTimeout:7000,
...
//Function for Custome Scrollbar for Serach Left mobile
$(".search_left").mCustomScrollbar({
	theme:"dark-3"
});
