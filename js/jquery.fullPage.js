...
if($( "#fp-nav li:first-child > a" ).hasClass( "active" )){
			$('#moveUp').hide();
		}else if($( "#fp-nav li:last-child > a" ).hasClass( "active" )){
			$('#moveDown').hide();
		}else{
			$('#moveUp').show();
			$('#moveDown').show();
        ...
        */
        function moveSectionUp(){
			...
			setTimeout(function(){ if($("#footer-section").hasClass("active"))
			{
				$("#resource-center").addClass("resource-active");
			}
			else
			{
				$("#resource-center").removeClass("resource-active");
			}
								  if($( "#fp-nav li:first-child > a" ).hasClass( "active" )){
			$('#moveUp').hide();
		}else if($( "#fp-nav li:last-child > a" ).hasClass( "active" )){
